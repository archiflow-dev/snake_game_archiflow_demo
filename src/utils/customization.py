...
class Theme:
    ...
    def __init__(self, name: str, theme_type: ThemeType,
                 ...
                 particle_colors: Dict[str, Tuple[int, int, int]] = None,
...
class CustomizationManager:
    ...
    def __init__(self, data_dir: str = "data/customization"):
        ...
        # Load custom assets (only if directory exists and has files)
    ...
    def _create_default_skins(self) -> None:
        ...
        default_skins = {
            ...
            "rainbow": Skin("Rainbow", SkinType.RAINBOW,
                         ColorScheme((255, 0, 0), (0, 255, 0), (0, 0, 255), (255, 255, 255)),
                         "gradient", True),
        }
